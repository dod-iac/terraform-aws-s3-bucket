...
func TestTerraformNotificationsExample(t *testing.T) {
	...
	testName := fmt.Sprintf("terratest-s3-bucket-notifications-%s", strings.ToLower(random.UniqueId()))

	tags := map[string]interface{}{
		"Automation": "Terraform",
		"Terratest":  "yes",
		"Test":       "TestTerraformNotificationsExample",
	}

	terraformOptions := terraform.WithDefaultRetryableErrors(t, &terraform.Options{
		// TerraformDir is where the terraform state is found.
		TerraformDir: "../examples/notifications",
