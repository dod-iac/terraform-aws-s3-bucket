...
func TestTerraformPolicyExample(t *testing.T) {
	...
	testName := fmt.Sprintf("terratest-s3-bucket-policy-%s", strings.ToLower(random.UniqueId()))

	tags := map[string]interface{}{
		"Automation": "Terraform",
		"Terratest":  "yes",
		"Test":       "TestTerraformPolicyExample",
	}
