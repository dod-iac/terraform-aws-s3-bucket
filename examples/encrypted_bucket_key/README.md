...
This example is used by the `TestTerraformEncryptedBucketKeyExample` test in `test/terrafrom_aws_encrypted_bucket_key_test.go`.
...
| <a name="module_s3_kms_key"></a> [s3\_kms\_key](#module\_s3\_kms\_key) | dod-iac/s3-kms-key/aws | 1.0.4 |
