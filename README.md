...
| <a name="input_object_ownership"></a> [object\_ownership](#input\_object\_ownership) | The object ownership setting. One of the following values: "BucketOwnerPreferred", "ObjectWriter", or "BucketOwnerEnforced". | `string` | `"ObjectWriter"` | no |
